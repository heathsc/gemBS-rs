...
// Derived - files that are (or can be) generated by gemBS
// Temp - files that may be deleted after they have been used (i.e., pool BCF files)
...
// Absent - file does not exist on files system
